    ...
    try {
        ...
        try {
            ...
            for (const daysAfter of reviewIntervals) {
                const scheduledFor = new Date(errorItem.createdAt);
            ...
            logger.info({ errorItemId: errorItem.id, schedulesGenerated: reviewIntervals.length }, 'Review schedules generated automatically');
