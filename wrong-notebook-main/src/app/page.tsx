...
import { Upload, BookOpen, Tags, LogOut, BarChart3, PenLine, Clock, CheckCircle2, AlertCircle, Brain } from "lucide-react";
...
import { ReviewSchedule as ReviewScheduleType } from "@/types/api";
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <div className="container mx-auto p-4 space-y-8 pb-20">
                ...
                {/* Action Center */}
                <div className={initialNotebookId ? "flex justify-center mb-6" : "space-y-6"}>
                    {/* Review Stats Cards - 智能复习统计 */}
                    {!initialNotebookId && reviewStats && (
                        <div 
                            className="grid grid-cols-2 md:grid-cols-4 gap-4 cursor-pointer"
                            onClick={() => router.push('/review')}
                        >
                            <div className="bg-card p-4 rounded-lg border shadow-sm hover:shadow-md hover:border-primary/50 transition-all">
